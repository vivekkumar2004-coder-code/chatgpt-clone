...
const Home = () => {
  ...
  const handleNewChat = async () => {
    ...
    const response = await axios.post(
      "https://chatgpt-clone-hk11.onrender.com/api/chat",
      {
        title,
      },
      {
  ...
  useEffect(() => {
    axios
      .get("https://chatgpt-clone-hk11.onrender.com/api/chat", {
        withCredentials: true,
      })
      .then((response) => {
    ...
    const tempSocket = io("https://chatgpt-clone-hk11.onrender.com", {
      withCredentials: true,
    });
  ...
  const getMessages = async (chatId) => {
    const response = await axios.get(
      `https://chatgpt-clone-hk11.onrender.com/api/chat/messages/${chatId}`,
      { withCredentials: true }
    );
